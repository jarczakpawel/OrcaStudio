...
void NetworkPluginDownloadDialog::create_missing_plugin_ui()
{
    ...
    auto* version_label = new wxStaticText(this, wxID_ANY,
        wxString::Format(_L("Version to install: %s"), wxString::FromUTF8(SLIC3R_VERSION)));
...
void NetworkPluginDownloadDialog::create_update_available_ui(const std::string& current_version)
{
    ...
    auto* update_label = new wxStaticText(this, wxID_ANY,
        wxString::Format(_L("Update to version: %s"), wxString::FromUTF8(SLIC3R_VERSION)));
